...
WebUI.scrollToElement(findTestObject('Appareal/Page_Apparel  accessories/div_Per Page10203040501 - 8 of 8             1'), 
    0)
...
WebUI.click(findTestObject('Object Repository/Page_SewRiveting - Custom Apparel/a_Apparel  accessories'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Order by Apparel/Page_Apparel  accessories/select_Date New  OldName A - ZName Z - APri_caf541'), 
    'pd.name-ASC', false)

WebUI.scrollToElement(findTestObject('Object Repository/Page_Apparel  accessories/div_Per Page10203040501 - 8 of 8             1'), 
    0)
...
WebUI.mouseOver(findTestObject('Object Repository/Page_SewRiveting - Custom Apparel/a_Apparel  accessories'))

WebUI.click(findTestObject('Object Repository/Page_Apparel  accessories/a_T-shirts'))
