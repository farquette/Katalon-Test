...
WebUI.scrollToElement(findTestObject('Menu_Category-Apparel/Page_Apparel  accessories/div_Per Page10203040501 - 8 of 8             1'), 
    0)
...
WebUI.mouseOver(findTestObject('Menu_Category-Apparel/Page_SewRiveting - Custom Apparel/a_Apparel  accessories'))

WebUI.click(findTestObject('Menu_Category-Apparel/Page_T-shirts/a_T-shirts'))
