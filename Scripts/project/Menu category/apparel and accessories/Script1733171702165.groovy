...
WebUI.click(findTestObject('Object Repository/Appareal/Page_SewRiveting - Custom Apparel/a_Apparel  accessories'))

WebUI.click(findTestObject('Object Repository/Appareal/Page_Apparel  accessories/i_Sort By_fa fa-th-list'))
